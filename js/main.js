        ...
        .then((response) => {
            ...
            <div class="row">
                ...
                <div class="col-md-4 box3">
                    ...
                    <div>
                        <a href="http://imdb.com/title/${movie.imdb_id}" target="_blank" class="btn-one">View aaaIMDB</a>
                        <a href="http://imdb.com/title/${movie.imdb_id}" target="_blank" class="btn-one">Add To Wishlist</a>
