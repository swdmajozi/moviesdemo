...
<head>
    ...
    <title>Welcome to Movies Demo</title>
            ...
            <center>
                <div class="inner-body ">
                    <h1 class="title ">Welcome to
                        <span style="color: #6AC045 ">Movies Demo</span>
                    </h1>
                    <p style="color: white" class="content">
                        Welcome to
                        <span style="font-weight:bold; color: #6AC045">Movies Demo</span> | It is site where you can view information about your favourite movie. Movies Demo
