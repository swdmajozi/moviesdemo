...
<body>
    ...
    <nav class="navbar navbar-expand-sm bg-secondary navbar-dark fixed-top ">
        ...
        <a class="navbar-brand" href="index.php">
            <img src="../image/icon.png" alt="logo"> Movies Demo
        </a>
        ...
        <div class="container">
            <div class="sbox">
                ...
                <div>
                    <center>
                        <div class="content">
                            <h1 style="color: white">Movies Demo: Information about over 10k+ movies</h1>
                            <p style="color: white">
                                Welcome to
                                <span style="font-weight:bold; color: #6AC045">Movies Demo</span> | It is site where you can view information about your favourite movie.
                                Movies Demoare best known for the excellent
    ...
    <div class="footer">
        <p>&copy; Copyright Developed by SW Majozi.</p>
    </div>
